...
mod tests {
    ...
    fn test_float_math_placeholder_round_trip() {
        let cases: &[(&str, RustFloatMathIntrinsic)] = &[
            ...
            (
                rust_intrinsics::CALLEE_ASINH_F32,
                RustFloatMathIntrinsic::AsinhF32,
            ),
            (
                rust_intrinsics::CALLEE_ACOSH_F64,
                RustFloatMathIntrinsic::AcoshF64,
            ),
            (
                rust_intrinsics::CALLEE_ATANH_F32,
                RustFloatMathIntrinsic::AtanhF32,
            ),
        ];
